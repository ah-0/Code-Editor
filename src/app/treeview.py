...
class FileIconProvider(QFileIconProvider):
    def icon(self, parameter):
        if isinstance(parameter, QFileInfo):
            ...
            if info.isDir():
                return QIcon("./src/icons/open-folder.png")
            if info.suffix() == "py":
            ...
            if info.suffix() == "java":
                return QIcon("./src/icons/java.png")
            if info.suffix() == "cpp":
                return QIcon("./src/icons/cpp_icon.png")
            if info.suffix() == "c":
                return QIcon("./src/icons/c_icon.png")  
            if info.suffix() == "png":  
                return QIcon("./src/icons/png_file.png")
            if info.suffix() == "jpg":

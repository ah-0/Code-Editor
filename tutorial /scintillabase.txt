...
SCI_GETLINE=2153,SCI_GETLINECOUNT=2154,
...
SCI_NULL=2172,SCI_CANPASTE=2173,
SCI_CANUNDO=2174,
...
SCI_TEXTHEIGHT=2279,SCI_SETVSCROLLBAR=2280,
...
SC_AC_NEWLINE=4,SC_AC_COMMAND=5
	...
	SC_ALPHA_TRANSPARENT=0,SC_ALPHA_OPAQUE=255,SC_ALPHA_NOALPHA=256
...
SC_IDLESTYLING_ALL=3
	...
	SC_IME_WINDOWED=0,SC_IME_INLINE=1

	SC_MARGINOPTION_NONE=0x00,SC_MARGINOPTION_SUBLINESELECT=0x01

	SC_MULTIAUTOC_ONCE=0,SC_MULTIAUTOC_EACH=1

	SC_MULTIPASTE_ONCE=0,SC_MULTIPASTE_EACH=1

	SC_POPUP_NEVER=0,SC_POPUP_ALL=1,SC_POPUP_TEXT=2
...
SC_STATUS_WARN_START=1000,SC_STATUS_WARNREGEX=1001
	...
	SC_TYPE_BOOLEAN=0,SC_TYPE_INTEGER=1,SC_TYPE_STRING=2
...
SC_WRAPVISUALFLAG_MARGIN=0x0004
	...
	SC_WRAPVISUALFLAGLOC_DEFAULT=0x0000,SC_WRAPVISUALFLAGLOC_END_BY_TEXT=0x0001,SC_WRAPVISUALFLAGLOC_START_BY_TEXT=0x0002

	SCTD_LONGARROW=0,SCTD_STRIKEOUT=1
...
STYLE_DEFAULT=32,STYLE_LINBER=33,STYLE_BRACELIGHT=34,
...
INDIC_POINT=18,INDIC_POINTCHARACTER=19,INDIC_IME=32,
INDIC_IME_MAX=35,INDIC_CONTAINER=8,INDIC_MAX=35,
INDIC0_MASK=0x20,INDIC1_MASK=0x40,INDIC2_MASK=0x80,
INDICS_MASK=0xe0,SC_INDICVALUEBIT=0x01000000,SC_INDICVALUEMASK=0x00ffffff,
...
SCFIND_REGEXP=0x00200000,SCFIND_POSIX=0x00400000,SCFIND_CXX11REGEX=0x00800000
	...
	SC_FOLDDISPLAYTEXT_HIDDEN=0,SC_FOLDDISPLAYTEXT_STANDARD=1,SC_FOLDDISPLAYTEXT_BOXED=2
...
SC_FOLDFLAG_LINEAFTER_CONTRACTED=0x0010,SC_FOLDFLAG_LEVELNUMBERS=0x0040,SC_FOLDFLAG_LINESTATE=0x0080
	...
	SC_LINE_END_TYPE_DEFAULT=0,SC_LINE_END_TYPE_UNICODE=1
...
SC_CACHE_DOCUMENT=3
	...
	SC_PHASES_ONE=0,SC_PHASES_TWO=1,SC_PHASES_MULTIPLE=2

	
ANNOTATION_HIDDEN=0,ANNOTATION_STANDARD=1,ANNOTATION_BOXED=2,
CARETSTYLE_INVISIBLE=3
...
SC_CURSORREVERSEARROW=7
	...
	VISIBLE_SLOP=0x01,VISIBLE_STRICT=0x04
...
CARET_EVEN=0x08
	...
	CARETSTYLE_INVISIBLE=0,CARETSTYLE_LINE=1,CARETSTYLE_BLOCK=2
...
SC_TECHNOLOGY_DIRECTWRITEDC=3
	...
	SC_CASEINSENSITIVEBEHAVIOUR_RESPECTCASE=0,SC_CASEINSENSITIVEBEHAVIOUR_IGNORECASE=1

	SC_FONT_SIZE_MULTIPLIER=100

	SC_FOLDACTION_CONTRACT=0,SC_FOLDACTION_EXPAND=1,SC_FOLDACTION_TOGGLE=2

	SC_AUTOMATICFOLD_SHOW=0x0001,SC_AUTOMATICFOLD_CLICK=0x0002,SC_AUTOMATICFOLD_CHANGE=0x0004

	SC_ORDER_PRESORTED=0,SC_ORDER_PERFORMSORT=1,SC_ORDER_CUSTOM=2
